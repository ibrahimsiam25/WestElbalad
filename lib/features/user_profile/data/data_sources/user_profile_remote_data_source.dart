...
class UserProfileRemoteDataSourceImpl extends UserProfileRemoteDataSource {
  ...
  @override
  Future<void> addUserimagetoFirestore(String documentId, String imageUrl)async {
   await databaseService.addDataInSubCollection(collection:BackendEndpoint.addUserData, docId: documentId, subCollection: BackendEndpoint.profileImage, subDocId: BackendEndpoint.profileImage, data: {"imageUrl":imageUrl});
  }
