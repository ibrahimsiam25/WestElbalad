...
import 'package:west_elbalad/features/admin/presentation/views/widgets/phone_data/remove_from_store_view_body_bloc_consumer.dart';
...
class RemoveFromStoreView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocProvider(
        create: (context) => RemoveFromStoreCubit(
          getIt<AdminRepo>(),
        )..fetchPhonesData(),
