...
import 'package:west_elbalad/features/admin/presentation/views/widgets/used_phones/edit_used_phone_data_element.dart';
            ...
            child: ClipRRect(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return EditUsedPhoneDataElement(phoneEntites: phone);
                },
              ),
            ),
          ),
