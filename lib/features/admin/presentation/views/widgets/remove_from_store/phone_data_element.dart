...
import 'package:west_elbalad/features/admin/presentation/views/widgets/remove_from_store/show_edit_price_dialog.dart';
          ...
          Row(
            children: [
              TextButton(
                ...
                onPressed: () {
                  showEditPriceDialog(context: context, onPriceSaved: (price) {
