...
import 'package:west_elbalad/core/widgets/custom_back_app_bar.dart';
...
class ShoppingCartViewBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  SingleChildScrollView(
      child: Column(
        children: [
          CustomBackAppBar(title: 'عربة التسوق'),
          BlocProvider(
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                        ...
                        child: ProductDataElement(
                          onPressed: () {
                            removeMapFromListInSharedPref(key: kOrder, mapToRemove: PhoneModel.fromEntity(state.orders[index]).toMap());
